...
class AppColors {
  ...
  static const Color grey3 = Color.fromARGB(255, 150, 146, 146);
  static const Color black = Color(0xff000000);
  static const Color backgroundcolor = Colors.white;
  // static const Color primaryColor = Color(0xffe74c3c);   0xffF8F9FD
  ...
  static const yellow = Color.fromRGBO(255, 233, 36, 1);
  static const thirdColor = Color(0xFFa2e1a6);
  static const pink = Color(0xFFf5bde8);
  static const purple = Color(0xFFcdacf9);
  static const red = Color(0xFFf77080);
// static const primaryColor = Color(0xFFf5ba92);
  ...
  // static const kPrimaryColor = Color(0xFFEB1555);
  static const kScaffoldBackgroundColor = Colors.black;
  static const kProcessButtunColor = Colors.green;
  static const kSnackSuccessBackground = Colors.green;
  static const kSnackErrorBackground = Colors.red;
  static const kPrimaryLightColor = Color(0xFFFFECDF);
  static const kDrawerBodyBackgroundColor = Colors.black;
